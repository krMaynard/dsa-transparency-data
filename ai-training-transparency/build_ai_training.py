...
CURATED_PDF = [
    ...
    {
        # Poland's Ministry of Digital Affairs — three continued-pretraining
        # PLLuM 2512 base models covered by one Polish-language filled template.
        "pdf": "pllum-2512-base-eu-training-summary.pdf",
        "provider": "Polish Ministry of Digital Affairs (PLLuM)",
        "model": "PLLuM 2512 base family",
        "released": "May 2026",
        "checks": ["PLLuM-4B-base-2512", "Llama-PLLuM-8B-base-2512",
                   "PLLuM-12B-base-2512", "21/05/2026", "12/2025", "DeepSeek-V3"],
        "rows": [
            ("modality", "Text", "1 billion to 10 trillion tokens"),
            ("modality", "Image", "Not applicable"),
            ("modality", "Audio", "Not applicable"),
    ...
    {
        # Four instruction-tuned PLLuM variants; this summary covers only the
        # additional fine-tuning data, as the AI Office template requires.
        "pdf": "pllum-2512-instruct-eu-training-summary.pdf",
        "provider": "Polish Ministry of Digital Affairs (PLLuM)",
        "model": "PLLuM 2512 instruct family",
        "released": "May 2026",
        "checks": ["PLLuM-4B-instruct-2512", "Llama-PLLuM-70B-instruct-2512",
                   "21/05/2026", "12/2025", "DeepSeek-V3"],
        "rows": [
            ("modality", "Text", "1 billion to 10 trillion tokens"),
            ("modality", "Image", "Not applicable"),
            ("modality", "Audio", "Not applicable"),
    ...
    {
        # Four aligned/chat PLLuM variants, again reporting the additional
        # alignment corpus rather than duplicating their base-model summary.
        "pdf": "pllum-2512-chat-eu-training-summary.pdf",
        "provider": "Polish Ministry of Digital Affairs (PLLuM)",
        "model": "PLLuM 2512 chat family",
        "released": "May 2026",
        "checks": ["PLLuM-4B-chat-2512", "Llama-PLLuM-70B-chat-2512",
                   "21/05/2026", "12/2025", "DeepSeek-V3"],
        "rows": [
            ("modality", "Text", "1 billion to 10 trillion tokens"),
            ("modality", "Image", "Not applicable"),
    ...
    {
        # EuroLLM's one template covers six 9B/22B base and instruction models.
        # It reports an exact ~4T-token text corpus within the middle size band.
        "pdf": "eurollm-eu-training-summary.pdf",
        "provider": "EuroLLM Team",
        "model": "EuroLLM 9B/22B family",
        "released": "December 2025",
        "checks": ["EuroLLM-9B", "EuroLLM-22B-Instruct-2512",
                   "31 July 2026", "4 trillion tokens", "Qwen2.5-Math-7B"],
        "rows": [
            ("modality", "Text", "1 billion to 10 trillion tokens (reported as: 4 trillion tokens)"),
            ("modality", "Image", "Not applicable"),
            ("modality", "Audio", "Not applicable"),
            ("modality", "Video", "Not applicable"),
            ("modality", "Other", "Not applicable"),
            ("general", "data_cutoff", "02/2024 (some math/post-training data later)"),
            ("data_source", "publicly_available", "Yes"),
            ("data_source", "commercially_licensed", "No"),
            ("data_source", "third_party_private", "No"),
            ("data_source", "crawled", "No"),
