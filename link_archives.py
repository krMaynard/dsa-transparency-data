...
HARMONISED = {
    ...
    # Batch of Google services (H2 2025).
    "pub.dev": "pubdev",
    "Google Workspace": "workspace",
    "Google Wallet API": "wallet-api",
    "Looker": "looker",
    "Google Pay API": "google-pay-api",
    "Google AI Developers Forum": "google-ai-developer-forum",
    "GDP Forums (Google)": "gdp-forums",
    "Google Vacation Rentals": "vacation-rentals",
    "Google Hotels": "google-hotels",
    "Google Flights": "google-flights",
    "Tenor": "tenor",
    "Google Photos": "google-photos",
    "Google Manufacturer Center": "manufacturer-center",
    "Google Help & Support": "google-help-support",
